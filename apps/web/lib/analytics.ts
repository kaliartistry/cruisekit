...
export function trackSaveCruiseStarted(params: DistributionEventParams) {
  ...
  trackEvent("sailing_save_started", distributionParams(params));
}
...
export function trackSaveCruiseCompleted(params: DistributionEventParams) {
  ...
  trackEvent("sailing_saved", distributionParams(params));
}
...
export function trackPortGuideCtaTapped(params: {
  portSlug?: string;
  cta: string;
}) {
  trackEvent("port_guide_cta_tapped", {
    port_slug: params.portSlug,
    cta: params.cta,
  });
}

export function trackRouteMapPortTapped(portSlug: string) {
  trackEvent("route_map_port_tapped", {
    port_slug: portSlug,
  });
}

export function trackCruiseDealsCtaTapped(sourceSurface: SourceSurface) {
  trackEvent("cruise_deals_cta_tapped", {
    source_surface: sourceSurface,
  });
}

export function trackShoreExcursionCtaTapped(params: {
  sourceSurface: SourceSurface;
  portSlug?: string;
}) {
  trackEvent("shore_excursion_cta_tapped", {
